...
public class UniIndexToken extends ClipboardToken {
    ...
    private PVPMark GetPVPMark(Pokemon evolvedPokemon, double aeCP){
        ...
        if(aeCP<=1500){
            String[] topArray = new String[]{"REGISTEEL", "ALTARIA", "AZUMARILL", "SWAMPERT", "TROPIUS", "ZWEILOUS", "DEWGONG", "WHISCASH", "BASTIODON", "MACHAMP", "UMBREON", "REGIROCK", "VENUSAUR", "SCRAFTY", "MEGANIUM", "MEDICHAM", "SKARMORY", "PRIMEAPE", "MANTINE", "VIGOROTH", "HITMONTOP", "LAPRAS", "MELMETAL", "SABLEYE", "WIGGLYTUFF", "MUNCHLAX", "QUAGSIRE", "DRAGONAIR", "HARIYAMA", "BLASTOISE", "LUCARIO", "CLEFABLE", "JIRACHI", "TOXICROAK", "LANTURN", "NOCTOWL", "REGICE", "EMPOLEON", "FLYGON", "HYPNO", "SHIFTRY", "BELLOSSOM", "PROBOPASS", "GLISCOR", "LICKITUNG", "FROSLASS", "HAUNTER", "GROTLE", "IVYSAUR", "MARSHTOMP", "TYPHLOSION", "BLAZIKEN", "SNORLAX", "VICTREEBEL", "ALOMOMOLA", "MAGNEZONE", "DRAGONITE", "FORRETRESS", "POLITOED", "SCEPTILE", "ARTICUNO", "POLIWRATH", "STEELIX", "ZANGOOSE", "HERACROSS", "HITMONCHAN", "DRIFBLIM", "LICKILICKY", "DRAPION", "BRONZONG", "RELICANTH", "GLOOM", "MILOTIC", "SKUNTANK", "GRANBULL", "LEAFEON", "TANGROWTH", "SEALEO", "AMPHAROS", "GLALIE", "GOLBAT", "MAGNETON", "SPIRITOMB", "LUDICOLO", "LATIOS", "LINOONE", "LUGIA", "WEEPINBELL", "GLIGAR", "VILEPLUME", "CRUSTLE", "GALLADE", "MINUN", "SUDOWOODO"};
        ...
        if(aeCP<=2500){
            String[] topArray = new String[]{"REGISTEEL", "GIRATINA", "SWAMPERT", "REGIROCK", "MACHAMP", "TYPHLOSION", "JIRACHI", "BLAZIKEN", "REGICE", "ZAPDOS", "SNORLAX", "HERACROSS", "ARTICUNO", "LICKILICKY", "BLASTOISE", "MELMETAL", "HARIYAMA", "LAPRAS", "VENUSAUR", "LUCARIO", "DRAGONITE", "AMPHAROS", "SUICUNE", "MOLTRES", "TOXICROAK", "EMPOLEON", "MEGANIUM", "POLITOED", "SCIZOR", "FLYGON", "ESCAVALIER", "INFERNAPE", "MAGNETON", "MAGNEZONE", "GALLADE", "CLEFABLE", "ZANGOOSE", "LUGIA", "MILOTIC", "POLIWRATH", "DRAPION", "PILOSWINE", "GLACEON", "CRUSTLE", "MUK", "GLISCOR", "CONKELDURR", "METAGROSS", "RELICANTH", "STEELIX", "HIPPOWDON", "KINGDRA", "MAMOSWINE", "SKARMORY", "PRIMEAPE", "KLINKLANG", "COBALION", "GENGAR", "LATIOS", "VIRIZION", "SEISMITOAD", "SCEPTILE", "RAIKOU", "CLOYSTER", "GYARADOS", "HONCHKROW", "GOLEM", "SKUNTANK", "OMASTAR", "FERALIGATR", "FORRETRESS", "MEWTWO", "NIDOQUEEN", "SCRAFTY", "ELECTIVIRE", "GRANBULL", "JOLTEON", "AGGRON", "DURANT", "URSARING", "CARRACOSTA", "HITMONTOP", "DIALGA", "HEATRAN", "PROBOPASS", "HITMONCHAN", "SHIFTRY", "TANGROWTH", "UXIE", "GARCHOMP", "HOUNDOOM", "BRELOOM", "BRONZONG", "WEAVILE", "CRYOGONAL", "NINETALES", "DRIFBLIM", "VAPOREON", "SCOLIPEDE", "UMBREON", "CRAWDAUNT", "ARCANINE", "KYOGRE", "HYDREIGON", "ENTEI", "GIGALITH", "UNFEZANT", "GARDEVOIR", "CELEBI", "LATIAS", "STARAPTOR", "STOUTLAND", "SLOWBRO", "PINSIR", "WHISCASH", "ALTARIA"};
            List<String> topList = Arrays.asList(topArray);
            if(topList.contains(name)) return new PVPMark(PVPLeague.ULTRA, 0.5);
            return new PVPMark(PVPLeague.ULTRA, 0);
        }

        String[] topArray = new String[]{"GIRATINA", "DIALGA", "MEWTWO", "KYOGRE", "DRAGONITE", "GARCHOMP", "LUGIA", "METAGROSS", "SNORLAX", "LATIOS", "GROUDON", "MELMETAL", "DARKRAI", "SWAMPERT", "REGIROCK", "GYARADOS", "HAXORUS", "CONKELDURR", "HYDREIGON", "MACHAMP", "JIRACHI", "RAIKOU", "REGICE", "HERACROSS", "VIRIZION", "GLACEON", "MAMOSWINE", "TYRANITAR", "ARTICUNO", "PALKIA", "LATIAS", "HEATRAN", "ZAPDOS", "RAYQUAZA", "GARDEVOIR", "MILOTIC", "GALLADE", "HARIYAMA", "MAGNEZONE", "WEAVILE", "SUICUNE", "CELEBI", "EMPOLEON", "MOLTRES", "VAPOREON", "REGISTEEL", "TYPHLOSION", "BLAZIKEN", "TANGROWTH", "TERRAKION", "LUCARIO", "FERALIGATR", "LAPRAS", "SCIZOR", "ENTEI", "SALAMENCE", "TORTERRA", "VENUSAUR", "LEAFEON", "GIGALITH", "URSARING", "EXCADRILL", "GRANBULL", "HIPPOWDON", "GENGAR", "MEGANIUM", "COBALION", "SCEPTILE", "CLEFABLE", "GOLEM", "BLASTOISE", "FLYGON", "CLOYSTER", "BEARTIC", "AMPHAROS", "RHYDON", "ESCAVALIER"};
        List<String> topList = Arrays.asList(topArray);
